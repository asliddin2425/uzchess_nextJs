...
//             <Image src={books.image} alt={books.title} width={132} height={177} className="m-5 overflow-hidden"/>
//             <h1 className="text-lg text-white font-bold ">{books.title}</h1>
//             <h6 className="  text-xs text-[#A7AAAB] font-normal line-through decoration-red-500">{books.price} uzs</h6>
//             <h6 className=" text-[#82CC27] font-bold text-[15px]">{books.newPrice} uzs</h6>
            
//             <div className="flex flex-row justify-between w-86.5 h-6   text-[#9FA1A2]">
//                 <h6 className="hover:cursor-pointer active:scale-[0.98]">{books.difficultyId}</h6>
//                 <div className="w-px h-5 bg-[#3D4549]"></div>
...
//                     <h6>{books.categoryId}</h6>
//                 </div>
//                 <div className="w-px h-5 bg-[#3D4549] "></div>
//                 <div className="flex flex-row w-max hover:cursor-pointer active:scale-[0.98]">
//                     <Image src={"/icons/icons-user 1.svg"} width={24} height={24} alt="icons"/>
//                     <h6>{books.author.fullName}</h6>
//                 </div>
//             </div>

//             {/* <button className=" flex  flex-row w-49.5 h-10 bg-[#1C92E0]  rounded-lg hover:cursor-pointer active:scale-[0.98]">
